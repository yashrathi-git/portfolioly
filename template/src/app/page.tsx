...
export default function Home() {
  ...
  const suggestions = [
    ...
    { id: "projects", label: "Projects", icon: "folderGit2", color: "bg-[oklch(0.646_0.222_41.116)]" },
    { id: "skills", label: "Skills", icon: "wrench", color: "bg-[oklch(0.6_0.118_184.704)]" },
    { id: "fun", label: "Fun", icon: "smile", color: "bg-[oklch(0.828_0.189_84.429)]" },
    { id: "contact", label: "Contact", icon: "mail", color: "bg-[oklch(0.769_0.188_70.08)]" },
  ...
  return (
    <ChatPortfolio profile={profile} suggestions={suggestions} presets={presets} />
  );
}