    ...
    <div className="space-y-5 pt-2">
      {messages.map((m) => (
        <div key={m.id} className="flex gap-3">
          ...
          <div
            className={`max-w-full md:max-w-[85%] rounded-2xl px-5 py-3.5 md:py-4 text-[15px] md:text-base leading-relaxed shadow-sm ${
              m.role === "assistant"
      ...
      {isThinking && (
        <div className="flex gap-3">
          ...
          <div className="rounded-2xl rounded-tl-none px-5 py-3.5 md:py-4 text-[15px] md:text-base bg-[var(--secondary)] text-[color:var(--secondary-foreground)] shadow-sm">
